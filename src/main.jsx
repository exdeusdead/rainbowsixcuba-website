...
const DATA = {
  es: {
    ...
    stats:{
      ...
      tabs:['Scoreboard','Jugadores','Mis Estadísticas','Operadores','Mapas','Temporadas','Discord Render','Companion'], search:'Buscar jugador, equipo o región', rank:'Rango', region:'Región', team:'Equipo', rows:'Filas', all:'Todos', clear:'Limpiar', showing:'Mostrando', of:'de', players:'perfiles',
...
function StatisticsPanel({t}){const s=t.stats; const tabKeys=['score','players','myStats','operators','maps','seasons','render','companion']; const [tab,setTab]=useState('score'); const [q,setQ]=useState(''); const [rank,setRank]=useState(''); const [region,setRegion]=useState(''); const [team,setTeam]=useState(''); const [limit,setLimit]=useState(10); const [cgpPlayers,setCgpPlayers]=useState([]);
