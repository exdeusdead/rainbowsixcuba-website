...
const modules = [
  { id: 'comunidad', image: '/assets/backgrounds/v11-community.webp', icon: Users, accent: 'red', url: '/community.html' },
  { id: 'eventos', image: '/assets/backgrounds/v11-events.webp', icon: CalendarDays, accent: 'red', url: '/events.html' },
  { id: 'competitivo', image: '/assets/backgrounds/v11-competitive.webp', icon: Trophy, accent: 'gold', url: '/competitive.html' },
  { id: 'estadisticas', image: '/assets/backgrounds/v11-statistics.webp', icon: BarChart3, accent: 'blue', url: '/statistics.html' },
  { id: 'coaches', image: '/assets/backgrounds/v11-coaches.webp', icon: GraduationCap, accent: 'purple', url: '/coaches.html' },
  { id: 'partners', image: '/assets/backgrounds/v11-partners.webp', icon: BadgeCheck, accent: 'green', url: '/partners.html' },
  { id: 'colaboradores', image: '/assets/backgrounds/v11-collaborators.webp', icon: Handshake, accent: 'red', url: '/collaborators.html' },
  { id: 'incoming', image: '/assets/backgrounds/v11-incoming.webp', icon: PackageOpen, accent: 'orange', url: '/roadmap.html' },
  { id: 'privacidad', image: '/assets/backgrounds/v11-privacy.webp', icon: LockKeyhole, accent: 'blue', url: '/privacy.html' }
];
